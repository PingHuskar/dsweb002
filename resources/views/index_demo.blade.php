...
-->
     ...
     <link rel="stylesheet" href="https://chadinchaipornpisuth.web.app/dsweb/css/bootstrap.min.css">
     <link rel="stylesheet" href="https://chadinchaipornpisuth.web.app/dsweb/css/font-awesome.min.css">
     <link rel="stylesheet" href="https://chadinchaipornpisuth.web.app/dsweb/css/owl.carousel.css">
     <link rel="stylesheet" href="https://chadinchaipornpisuth.web.app/dsweb/css/owl.theme.default.min.css">

     <!-- MAIN CSS -->
     <link rel="stylesheet" href="https://chadinchaipornpisuth.web.app/dsweb/css/templatemo-style.css">
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <div class="team-thumb">
                              <div class="team-image">
                                   <img src="{{url('index/images/author-image1.jpg')}}" class="img-responsive" alt="">
                              </div>
                              <div class="team-info">
                                   <h3>Mark Wilson</h3>
     ...
     <!-- SCRIPTS -->
     <script src="https://chadinchaipornpisuth.web.app/dsweb/js/jquery.js"></script>
     <script src="https://chadinchaipornpisuth.web.app/dsweb/js/bootstrap.min.js"></script>
     <script src="https://chadinchaipornpisuth.web.app/dsweb/js/owl.carousel.min.js"></script>
     <script src="https://chadinchaipornpisuth.web.app/dsweb/js/smoothscroll.js"></script>
     <script src="https://chadinchaipornpisuth.web.app/dsweb/js/custom.js"></script>
