  ...
  <section class="sec-padding">
    <div class="container">
      <div class="row">
        ...
        <h3 class=" roboto-slab uppercase less-mar3">Research</h3>
            <div class="title-line-9 less-margin align-center"></div>
            <div class="clearfix"></div>
            
          
          <div class="col-md-6">
            <div class="text-box border padding-4 bmargin">
              <h4 class="roboto-slab font-weight-4">Artificial Intelligence and Intelligent Systems</h4>
        ...
        <div class="col-md-6">
            <div class="text-box border padding-4 bmargin">
              <h4 class="roboto-slab font-weight-4">Data Mining and Information Retrieval </h4>
